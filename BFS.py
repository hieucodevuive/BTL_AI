...
class GraphSearchBFS:  # Change the class name to GraphSearchBFS
    def __init__(self):
        self.visited = set()
        self.path = []

    def breadth_first_search(self, start_state, target_state):
        queue = [start_state]
        ...
        while queue:
            ...
            for neighbor_state in current_state.neighbors:
                if neighbor_state not in self.visited:
                    ...
                    self.visited.add(neighbor_state)
                    self.path.append(current_state)
...
class GraphSearchApp:
    def __init__(self, master, states):
        ...
        self.graph_search = GraphSearchBFS()
    ...
    def perform_search(self):
        ...
        try:
            ...
            # Lấy đường dẫn từ GraphSearcBFS
            self.graph_search.breadth_first_search(start_state, target_state)
